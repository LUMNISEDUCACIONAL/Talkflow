...
export const SpotifyIcon: React.FC<IconProps> = ({ className }) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={className}>
        <title>Spotify</title>
        <path d="M12 2.722c-5.133 0-9.278 4.145-9.278 9.278s4.145 9.278 9.278 9.278 9.278-4.145 9.278-9.278S17.133 2.722 12 2.722zm4.394 12.868c-.183.293-.53.393-.823.21l-3.53-2.15c-.293-.183-.393-.53-.21-.823.183-.293.53-.393.823-.21l3.53 2.15c.293.183.393.53.21.823zm.886-2.502c-.22.357-.65.48-1.007.26l-4.22-2.564c-.357-.22-.48-.65-.26-1.007.22-.357.65-.48 1.007-.26l4.22 2.564c.357.22.48.65.26 1.007zm.9-2.564c-.265.433-.787.58-1.22.314l-4.933-2.99c-.433-.265-.58-.787-.314-1.22.265-.433.787-.58 1.22-.314l4.933 2.99c.433.265.58.787.314 1.22z"/>
    </svg>
);
